...
const CARD_DB = [
  ...
  { id:'ST07-014', name:'Gypsy the Crusader', type:'CHARACTER', color:'Yellow', attribute:'Strike', affiliation:'Apostles High Council',
    ...
    ability:"\"no stranger to me is this wanderer: many years ago passed he by.\"" },
  ...
  switch (action.type) {
    ...
    case 'PLAY_CARD': {
      ...
      if (card.type === 'CHARACTER') {
        ...
        // lookup finds the event by uid when its windows resolve.
        p.trash.push(card);
    ...
    case 'PLAY_FROM_HAND_RESOLVE': {
      ...
      if (isOnPlaySuppressed(game, playerId)) {
        ...
        runPipeline('onPlay', game, playerId, picked);
      }
